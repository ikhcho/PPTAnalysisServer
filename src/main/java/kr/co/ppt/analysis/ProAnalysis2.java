...
public class ProAnalysis2 implements Analysis{
	...
	public ProAnalysis2(List<ProDicVO> proDicList, List<StockVO> stockList) {
		super();
		this.proDicList = proDicList;
		this.stockList = stockList;
	}
	
	public ProAnalysis2(JSONArray prodicArr, List<StockVO> stockList) {
	...
	public String makeCSV(){
		String path = "D:\\PPT\\analysis\\pro2.csv";
		FileOutputStream fos;
		try {
			fos = new FileOutputStream(path);
			fos.write("pro2Inc,pro2Dec,pro2Equ,result\n".getBytes("utf-8"));
			for(String text : csv){
				fos.write((text+"\n").getBytes("utf-8"));
			}
			fos.close();
