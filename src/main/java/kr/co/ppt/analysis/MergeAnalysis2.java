...
public class MergeAnalysis2 implements Analysis{
	...
	public MergeAnalysis2(List<OpiDicVO> posList, List<OpiDicVO> negList, List<ProDicVO> proDicList,
	...
	public MergeAnalysis2(JSONObject posJson, JSONObject negJson, JSONArray prodicArr, 
			List<StockVO> stockList, List<TfidfVO> tfidfList) {
	...
	public String makeCSV(){
		String path = "D:\\PPT\\analysis\\meg2.csv";
		FileOutputStream fos;
		try {
			fos = new FileOutputStream(path);
			fos.write("meg2Inc,meg2Dec,meg2Equ,result\n".getBytes("utf-8"));
			for(String text : csv){
				fos.write((text+"\n").getBytes("utf-8"));
			}
			fos.close();
